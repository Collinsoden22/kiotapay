...
api.add_resource(UserEndpoint, BASE_URL + '/user/', BASE_URL + '/user/<int:user_id>', endpoint="user")
# TodoEndpoint todo/<req_id> will get todo with mathing id
api.add_resource(TodoEndpoint, BASE_URL + "/todo/<int:todo_id>", BASE_URL + "/todo/", endpoint="todo")
